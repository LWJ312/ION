...
class BaseModel(torch.nn.Module):
    def __init__(self, args):
        ...
        self.detection_feature = nn.Linear(566, 49)
    ...
    def embedding(self, state, target, action_embedding_input):
        ...
        target = torch.cat((target['cur_appear'], target['cur_info'], target['indicator']), dim=1)
    ...
    def forward(self, model_input, model_options):
        ...
        # rand
        # actor_out = actor_out[:,torch.randperm(actor_out.size(1))]
