...
def full_eval(args=None):
    ...
    # best models
    # args.load_model = os.path.join(args.save_model_dir, "BaseModel_15985058_1200000_2021_04_09_16_27_47.dat")
    # args.load_model = os.path.join(args.save_model_dir, "IRGModel_16838178_1100000_2021_04_09_16_27_11.dat")
    # args.load_model = os.path.join(args.save_model_dir, "IRGSemMap_55864969_4000000_2021_07_29_08_23_30.dat")
