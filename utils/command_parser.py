...
def parse_arguments():
    parser = argparse.ArgumentParser(description='Instance-level Object Navigation')
    ...
    parser.add_argument(
        ...
        type=int,
        default=29,
        help='the number of goal categories'
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default='ins_visible_location_bbox.json',
    ...
    parser.add_argument(
        ...
        help='Which type of agent. Choices are BasicEpisode or TestValEpisode.',
    )
